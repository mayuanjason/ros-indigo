...
from tb_tasks.task_setup import *
from tb_tasks.clean_house_tasks_tree import *
...
class CleanHouse:
    ...
    def __init__(self):
        ...
        # Create a navagation task for each room
        ...
        with STAY_HEALTHY:
            # Add the "check battery"" condition (use MonitorTask)
            CHECK_BATTERY = MonitorTask("CHECK_BATTERY", "battery_level", Float32, self.check_battery)

            # Add the "charge robot" task (use ServiceTask)
            ...
            # Add the "check battery" and "charge robot" tasks to the "stay healthy" selector
        ...
        for room in black_board.task_list.keys():
            ...
            NAV_ROOM[room] = Selector("NAV_" + ROOM)

            # Initialize the "CHECK_LOCATION" condition to the "NAV_ROOM" selector
            ...
            for task in black_board.task_list[room]:
                ...
                # Add the "UPDATE_TASK_LIST" tasks to the "DO_TASK" sequence
        ...
        # Display the tree before before execution
