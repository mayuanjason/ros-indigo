...
class Patrol:
    ...
    def __init__(self):
        ...
        # Initialize a number of parameters and
        ...
        NAV_DOCK_TASK = SimpleActionTask("NAV_DOCK_TASK", "move_base", MoveBaseAction, goal, reset_after=True)
    ...
    def check_battery(self, msg):
        if msg.data is None:
            ...
            if msg.data < self.low_battery_threshold:
                rospy.loginfo("LOW BATTERY - level: " + str(int(int(msg.data))))
