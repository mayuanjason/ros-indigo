...
class Patrol:
    ...
    def __init__(self):
        ...
        # Set the taget location to the first waypoint
        self.location = 1
    ...
    def patrol(self):
        ...
        # Create a MoveBaseGoal from waypoint
        goal = MoveBaseGoal()
        ...
        # script so we break it down in time slices of duration 1 / rate.
    ...
    def recharge(self):
        ...
        # Create a MoveBaseGoal from docking station pose
        goal = MoveBaseGoal()
        goal.target_pose.header.frame_id = 'map'
        goal.target_pose.header.stamp = rospy.Time.now()
