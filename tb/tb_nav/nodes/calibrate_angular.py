...
from tb_nav.cfg import CalibrateAngularConfig
import tf
from tb_nav.transform_utils import normalize_angle
...
class CalibrateAngular:
    ...
    def __init__(self):
        ...
        self.tolerance = rospy.get_param("~tolerance", 1)  # degrees convert to radians
        ...
        # Connect to the dynamic_reconfigure sever
        ...
        while not rospy.is_shutdown():
            if self.start_test:
                ...
                while abs(error) > self.tolerance and self.start_test:
                    ...
                    # Roate the robot to reduce the error
                    move_cmd = Twist()
