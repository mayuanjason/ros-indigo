...
class ObjectFollower():
    ...
    def set_cmd_vel(self, msg):
        ...
        try:
            ...
            if abs(percent_offset_x) > self.x_threshold:
                ...
                self.move_cmd.angular.z = -copysign(max(self.min_rotation_speed, min(self.max_rotation_speed, abs(speed))), speed)
            else:
            ...
            # Get the average depth value over ROI
    ...
    def convert_depth_image(self, ros_image):
        # Use cv_bridge() to convert the ROI image to OpenCV format
        try:
